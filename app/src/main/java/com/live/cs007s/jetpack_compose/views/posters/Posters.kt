...
import com.live.cs007s.jetpack_compose.extensions.visible
import com.live.cs007s.jetpack_compose.model.Poster
import com.live.cs007s.jetpack_compose.views.main.MainViewModel
import com.live.cs007s.jetpack_compose.views.theme.purple200
  ...
  ConstraintLayout {
    ...
    Scaffold(
      ...
      Crossfade(selectedTab) { destination ->
        when (destination) {
          HomeTab.HOME -> HomePosters(modifier, posters, selectPoster)
          HomeTab.RADIO -> RadioPosters(modifier, posters, selectPoster)
          HomeTab.LIBRARY -> LibraryPosters(modifier, posters, selectPoster)
        }
      }
    }
